...
/**
 * Temporary compatibility implementation for the pre-TAR server protocol.
 * Direct-TAR storage is exported from tar-session-store.ts below.  This class
 * remains only so the old wire/server layer can compile until its replacement.
 */
